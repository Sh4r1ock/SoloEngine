...
from mcp_service.config import MCP_SERVICE_PORT, MCP_SERVICE_HOST, CORS_ORIGINS
from mcp_service.routes import router
from mcp_service.database import init_db
