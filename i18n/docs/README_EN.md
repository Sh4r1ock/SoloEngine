...
- **Tools, skills, MCP — hot-pluggable** — Each Agent loads tools and skills at runtime. Progressive disclosure saves 85%+ on tokens.
...
Open [**http://localhost:8991**](http://localhost:8991) and build your first Agent team.
